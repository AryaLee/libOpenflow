...
func (p OpenFlow10Protocol) GetVersion() uint8 {
	return ofbase.VERSION_1_0
}

// NewHello returns a new hello message
func (p OpenFlow10Protocol) NewHello(versionBitmap uint32) ofbase.Message {
	return NewHello()
}

// NewEchoRequest returns a new echo request message
func (p OpenFlow10Protocol) NewEchoRequest() ofbase.Message {
	return NewEchoRequest()
}

// NewEchoReply returns a new echo reply message
func (p OpenFlow10Protocol) NewEchoReply() ofbase.Message {
	return NewEchoReply()
}

// NewBarrierRequest returns a new barrier request message
func (p OpenFlow10Protocol) NewBarrierRequest() ofbase.Message {
	return NewBarrierRequest()
}

// DecodeMessage parses an OpenFlow message
func (p OpenFlow10Protocol) DecodeMessage(data []byte) (ofbase.Message, error) {
