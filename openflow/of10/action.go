...
func (self *ActionEnqueue) Serialize(encoder *ofbase.Encoder) error {
	if err := self.Action.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeActionEnqueue(parent *Action, decoder *ofbase.Decoder) (*ActionEnqueue, error) {
...
func (self *ActionStripVlan) Serialize(encoder *ofbase.Encoder) error {
	if err := self.Action.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeActionStripVlan(parent *Action, decoder *ofbase.Decoder) (*ActionStripVlan, error) {
