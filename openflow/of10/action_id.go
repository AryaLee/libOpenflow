...
func (self *ActionIdEnqueue) Serialize(encoder *ofbase.Encoder) error {
	if err := self.ActionId.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeActionIdEnqueue(parent *ActionId, decoder *ofbase.Decoder) (*ActionIdEnqueue, error) {
...
func (self *ActionIdStripVlan) Serialize(encoder *ofbase.Encoder) error {
	if err := self.ActionId.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeActionIdStripVlan(parent *ActionId, decoder *ofbase.Decoder) (*ActionIdStripVlan, error) {
