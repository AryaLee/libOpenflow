...
func (self *FlowStatsEntry) GetActions() []ofbase.IAction {
	return self.Actions
}

func (self *FlowStatsEntry) SetActions(v []ofbase.IAction) {
	self.Actions = v
}
...
func (self *MatchV1) Serialize(encoder *ofbase.Encoder) error {
...
func (self *MatchV1) Decode(decoder *ofbase.Decoder) error {
