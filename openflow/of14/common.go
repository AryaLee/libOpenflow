...
func (self *InstructionIdMeter) Serialize(encoder *ofbase.Encoder) error {
	if err := self.InstructionId.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionIdMeter(parent *InstructionId, decoder *ofbase.Decoder) (*InstructionIdMeter, error) {
...
func DecodeTableModPropEviction(decoder *ofbase.Decoder) (*TableModPropEviction, error) {
...
func DecodeTableModPropExperimenter(decoder *ofbase.Decoder) (ITableModPropExperimenter, error) {
...
func DecodeTableModPropVacancy(decoder *ofbase.Decoder) (*TableModPropVacancy, error) {
