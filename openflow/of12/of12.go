...
func (p OpenFlow12Protocol) GetVersion() uint8 {
	return ofbase.VERSION_1_2
}

// NewHello returns a new hello message
func (p OpenFlow12Protocol) NewHello(versionBitmap uint32) ofbase.Message {
	return NewHello()
}

// NewEchoRequest returns a new echo request message
func (p OpenFlow12Protocol) NewEchoRequest() ofbase.Message {
	return NewEchoRequest()
}

// NewEchoReply returns a new echo reply message
func (p OpenFlow12Protocol) NewEchoReply() ofbase.Message {
	return NewEchoReply()
}

// NewBarrierRequest returns a new barrier request message
func (p OpenFlow12Protocol) NewBarrierRequest() ofbase.Message {
	return NewBarrierRequest()
}

// DecodeMessage parses an OpenFlow message
func (p OpenFlow12Protocol) DecodeMessage(data []byte) (ofbase.Message, error) {
