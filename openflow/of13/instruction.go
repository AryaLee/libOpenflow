...
func (self *Instruction) Serialize(encoder *ofbase.Encoder) error {
...
func DecodeInstruction(decoder *ofbase.Decoder) (IInstruction, error) {
...
func (self *InstructionApplyActions) GetActions() []ofbase.IAction {
	return self.Actions
}

func (self *InstructionApplyActions) SetActions(v []ofbase.IAction) {
	self.Actions = v
}

func (self *InstructionApplyActions) Serialize(encoder *ofbase.Encoder) error {
...
func DecodeInstructionApplyActions(parent *Instruction, decoder *ofbase.Decoder) (*InstructionApplyActions, error) {
...
func (self *InstructionExperimenter) Serialize(encoder *ofbase.Encoder) error {
	if err := self.Instruction.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionExperimenter(parent *Instruction, decoder *ofbase.Decoder) (IInstructionExperimenter, error) {
...
func (self *InstructionBsn) Serialize(encoder *ofbase.Encoder) error {
...
func DecodeInstructionBsn(parent *InstructionExperimenter, decoder *ofbase.Decoder) (IInstructionBsn, error) {
...
func (self *InstructionBsnArpOffload) Serialize(encoder *ofbase.Encoder) error {
...
func DecodeInstructionBsnArpOffload(parent *InstructionBsn, decoder *ofbase.Decoder) (*InstructionBsnArpOffload, error) {
...
func (self *InstructionBsnAutoNegotiation) Serialize(encoder *ofbase.Encoder) error {
	if err := self.InstructionBsn.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionBsnAutoNegotiation(parent *InstructionBsn, decoder *ofbase.Decoder) (*InstructionBsnAutoNegotiation, error) {
...
func (self *InstructionBsnDeny) Serialize(encoder *ofbase.Encoder) error {
	if err := self.InstructionBsn.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionBsnDeny(parent *InstructionBsn, decoder *ofbase.Decoder) (*InstructionBsnDeny, error) {
...
func (self *InstructionBsnDhcpOffload) Serialize(encoder *ofbase.Encoder) error {
	if err := self.InstructionBsn.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionBsnDhcpOffload(parent *InstructionBsn, decoder *ofbase.Decoder) (*InstructionBsnDhcpOffload, error) {
...
func (self *InstructionBsnDirectedBroadcast) Serialize(encoder *ofbase.Encoder) error {
	if err := self.InstructionBsn.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionBsnDirectedBroadcast(parent *InstructionBsn, decoder *ofbase.Decoder) (*InstructionBsnDirectedBroadcast, error) {
...
func (self *InstructionBsnDisableL3) Serialize(encoder *ofbase.Encoder) error {
	if err := self.InstructionBsn.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionBsnDisableL3(parent *InstructionBsn, decoder *ofbase.Decoder) (*InstructionBsnDisableL3, error) {
...
func (self *InstructionBsnDisableSplitHorizonCheck) Serialize(encoder *ofbase.Encoder) error {
	if err := self.InstructionBsn.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionBsnDisableSplitHorizonCheck(parent *InstructionBsn, decoder *ofbase.Decoder) (*InstructionBsnDisableSplitHorizonCheck, error) {
...
func (self *InstructionBsnDisableSrcMacCheck) Serialize(encoder *ofbase.Encoder) error {
	if err := self.InstructionBsn.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionBsnDisableSrcMacCheck(parent *InstructionBsn, decoder *ofbase.Decoder) (*InstructionBsnDisableSrcMacCheck, error) {
...
func (self *InstructionBsnDisableVlanCounters) Serialize(encoder *ofbase.Encoder) error {
	if err := self.InstructionBsn.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionBsnDisableVlanCounters(parent *InstructionBsn, decoder *ofbase.Decoder) (*InstructionBsnDisableVlanCounters, error) {
...
func (self *InstructionBsnHashSelect) Serialize(encoder *ofbase.Encoder) error {
	if err := self.InstructionBsn.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionBsnHashSelect(parent *InstructionBsn, decoder *ofbase.Decoder) (*InstructionBsnHashSelect, error) {
...
func (self *InstructionBsnInternalPriority) Serialize(encoder *ofbase.Encoder) error {
	if err := self.InstructionBsn.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionBsnInternalPriority(parent *InstructionBsn, decoder *ofbase.Decoder) (*InstructionBsnInternalPriority, error) {
...
func (self *InstructionBsnNdpOffload) Serialize(encoder *ofbase.Encoder) error {
	if err := self.InstructionBsn.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionBsnNdpOffload(parent *InstructionBsn, decoder *ofbase.Decoder) (*InstructionBsnNdpOffload, error) {
...
func (self *InstructionBsnPacketOfDeath) Serialize(encoder *ofbase.Encoder) error {
	if err := self.InstructionBsn.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionBsnPacketOfDeath(parent *InstructionBsn, decoder *ofbase.Decoder) (*InstructionBsnPacketOfDeath, error) {
...
func (self *InstructionBsnPermit) Serialize(encoder *ofbase.Encoder) error {
	if err := self.InstructionBsn.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionBsnPermit(parent *InstructionBsn, decoder *ofbase.Decoder) (*InstructionBsnPermit, error) {
...
func (self *InstructionBsnPrioritizePdus) Serialize(encoder *ofbase.Encoder) error {
	if err := self.InstructionBsn.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionBsnPrioritizePdus(parent *InstructionBsn, decoder *ofbase.Decoder) (*InstructionBsnPrioritizePdus, error) {
...
func (self *InstructionBsnRequireVlanXlate) Serialize(encoder *ofbase.Encoder) error {
	if err := self.InstructionBsn.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionBsnRequireVlanXlate(parent *InstructionBsn, decoder *ofbase.Decoder) (*InstructionBsnRequireVlanXlate, error) {
...
func (self *InstructionBsnSpanDestination) Serialize(encoder *ofbase.Encoder) error {
	if err := self.InstructionBsn.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionBsnSpanDestination(parent *InstructionBsn, decoder *ofbase.Decoder) (*InstructionBsnSpanDestination, error) {
...
func (self *InstructionClearActions) Serialize(encoder *ofbase.Encoder) error {
	if err := self.Instruction.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionClearActions(parent *Instruction, decoder *ofbase.Decoder) (*InstructionClearActions, error) {
...
func (self *InstructionGotoTable) Serialize(encoder *ofbase.Encoder) error {
	if err := self.Instruction.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionGotoTable(parent *Instruction, decoder *ofbase.Decoder) (*InstructionGotoTable, error) {
...
func (self *InstructionMeter) Serialize(encoder *ofbase.Encoder) error {
	if err := self.Instruction.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionMeter(parent *Instruction, decoder *ofbase.Decoder) (*InstructionMeter, error) {
...
func (self *InstructionWriteActions) GetActions() []ofbase.IAction {
	return self.Actions
}

func (self *InstructionWriteActions) SetActions(v []ofbase.IAction) {
	self.Actions = v
}

func (self *InstructionWriteActions) Serialize(encoder *ofbase.Encoder) error {
	if err := self.Instruction.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionWriteActions(parent *Instruction, decoder *ofbase.Decoder) (*InstructionWriteActions, error) {
...
func (self *InstructionWriteMetadata) Serialize(encoder *ofbase.Encoder) error {
	if err := self.Instruction.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionWriteMetadata(parent *Instruction, decoder *ofbase.Decoder) (*InstructionWriteMetadata, error) {
