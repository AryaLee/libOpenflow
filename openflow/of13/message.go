...
func (self *BsnRoleStatus) Serialize(encoder *ofbase.Encoder) error {
	if err := self.BsnHeader.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeBsnRoleStatus(parent *BsnHeader, decoder *ofbase.Decoder) (*BsnRoleStatus, error) {
...
func (self *QueueGetConfigReply) Serialize(encoder *ofbase.Encoder) error {
	if err := self.Header.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeQueueGetConfigReply(parent *Header, decoder *ofbase.Decoder) (*QueueGetConfigReply, error) {
...
func (self *QueueGetConfigRequest) Serialize(encoder *ofbase.Encoder) error {
	if err := self.Header.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeQueueGetConfigRequest(parent *Header, decoder *ofbase.Decoder) (*QueueGetConfigRequest, error) {
