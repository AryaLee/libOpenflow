...
func (self *Oxs) Serialize(encoder *ofbase.Encoder) error {
...
func DecodeOxs(decoder *ofbase.Decoder) (IOxs, error) {
	_oxs := &Oxs{}
	if decoder.Length() < 4 {
...
func (self *OxsByteCount) Serialize(encoder *ofbase.Encoder) error {
...
func DecodeOxsByteCount(parent *Oxs, decoder *ofbase.Decoder) (*OxsByteCount, error) {
...
func (self *OxsDuration) Serialize(encoder *ofbase.Encoder) error {
	if err := self.Oxs.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeOxsDuration(parent *Oxs, decoder *ofbase.Decoder) (*OxsDuration, error) {
...
func (self *OxsFlowCount) Serialize(encoder *ofbase.Encoder) error {
	if err := self.Oxs.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeOxsFlowCount(parent *Oxs, decoder *ofbase.Decoder) (*OxsFlowCount, error) {
...
func (self *OxsIdleTime) Serialize(encoder *ofbase.Encoder) error {
	if err := self.Oxs.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeOxsIdleTime(parent *Oxs, decoder *ofbase.Decoder) (*OxsIdleTime, error) {
...
func (self *OxsPacketCount) Serialize(encoder *ofbase.Encoder) error {
	if err := self.Oxs.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeOxsPacketCount(parent *Oxs, decoder *ofbase.Decoder) (*OxsPacketCount, error) {
