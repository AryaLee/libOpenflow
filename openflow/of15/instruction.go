...
func (self *InstructionStatTrigger) Serialize(encoder *ofbase.Encoder) error {
	if err := self.Instruction.Serialize(encoder); err != nil {
		return err
	}
...
func DecodeInstructionStatTrigger(parent *Instruction, decoder *ofbase.Decoder) (*InstructionStatTrigger, error) {
